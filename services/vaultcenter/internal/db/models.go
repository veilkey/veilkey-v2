...
type TokenRef struct {
	...
	RefVault      string     `gorm:"column:ref_vault;size:64;not null;default:'';index:idx_token_refs_vault;index:idx_token_refs_vault_path" json:"ref_vault"`
	RefGroup      string     `gorm:"column:ref_group;size:64;not null;default:''" json:"ref_group"`
	RefKey        string     `gorm:"column:ref_key;size:64;not null;default:''" json:"ref_key"`
	RefPath       string     `gorm:"column:ref_path;size:255;not null;default:'';index:idx_token_refs_vault_path" json:"ref_path"`
